...
#+AUTHOR: Joakim Verona, Per Weijnitz, SGC
#+DATE: Present day
...
#+LaTeX_HEADER: \pagecolor[rgb]{1,1,1}   %white
#+LaTeX_HEADER: \color[rgb]{0,0,0}       %black
...
#+LaTeX_HEADER: \renewcommand{\maketitlehookd}{\vfill\vfill\begin{center}\includegraphics[width=0.8\linewidth]{assets/geometry-lost.png}\end{center}\vfill}
...
\newpage
\SetBgImage$SHAPE2
#+INCLUDE: articles/hypercube-topic-space-boundary.org
